...
function getFilterIconLink(icon, category, key, value, title) {
  return `
  <a href="#" class="row justify-content-between filter-element-link" data-value="${key}" data-type="${category}" onclick="addFilter(this)" title="${
    title ? title : key
  }">
...
function updateProblemsView() {
  ...
  const showMoreContent =
    problemsLimit < Object.keys(problemsByFile).length
      ? `${problemsLimit} of ${
          Object.keys(problemsByFile).length
